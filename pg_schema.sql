...
--
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: pari
--
...
--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: public; Owner: pari
--

ALTER DEFAULT PRIVILEGES FOR ROLE pari IN SCHEMA public GRANT ALL ON TABLES  TO dhms_user;
