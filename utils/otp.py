...
SENDER_EMAIL = os.getenv('MAIL_USERNAME')  # Replace with your email
SENDER_PASSWORD = os.getenv('MAIL_PASSWORD') # Replace with your email password

# OTP expiry time (300 seconds)
OTP_EXPIRY_TIME = 300
        ...
        <html>
            ...
            <body>
                <div class="container">
                    ...
                    <p>This OTP is valid for 5 minutes. Please use it before it expires.</p>
